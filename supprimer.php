...
<div class="row">
  <div class="col-md-12">
    <br>
    <br> <center><h1 class="">Listes Articles (Suppression)</h1></center> <hr>
  </div>
</div>
<div class="row">
  <div class="col-md-2">
...
while ($ligne=mysqli_fetch_array($res)){
    echo("<tr><td>$ligne[0]<td>$ligne[1]<td>$ligne[2]<td>$ligne[3]<td>$ligne[4]<td>$ligne[5]<td><a href='sup1.php?id=$ligne[0]'><button type=button class='btn btn-danger'>Supprimer</button></a>");
}
?>
 </center>
      </div>
